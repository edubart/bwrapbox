...
/* Compile hash: 4CeovASCrJTmozwTqqNB3xWaSxVh */
/* ------------------------------ DIRECTIVES -------------------------------- */
#include <stdbool.h>
...
typedef nlmulret_nlboolean_nlint64_bwrapbox_limit_pair (*function_3gxPkn6wkRU9apZHZ)(nelua_sequence_limit_pair_, int64_t);
struct nelua_sequenceimpl_limit_pair_ {
  nelua_span_limit_pair_ data;
  uintptr_t size;
};
typedef struct nlmulret_function_3gxPkn6wkRU9apZHZ_nelua_sequence_limit_pair__nlint64 {
  function_3gxPkn6wkRU9apZHZ r1;
  nelua_sequence_limit_pair_ r2;
  int64_t r3;
} nlmulret_function_3gxPkn6wkRU9apZHZ_nelua_sequence_limit_pair__nlint64;
static NELUA_INLINE nlmulret_function_3gxPkn6wkRU9apZHZ_nelua_sequence_limit_pair__nlint64 nelua_ipairs_1(nelua_sequence_limit_pair_ a);
static nlmulret_nlboolean_nlint64_bwrapbox_limit_pair nelua_ipairs_next(nelua_sequence_limit_pair_ a_1, int64_t k);
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_2KKnvHarpGFGqFSRr)(nelua_sequence_string__1, int64_t);
struct nelua_sequenceimpl_string__1 {
  nelua_span_string_ data;
  uintptr_t size;
};
typedef struct nlmulret_function_2KKnvHarpGFGqFSRr_nelua_sequence_string__1_nlint64 {
  function_2KKnvHarpGFGqFSRr r1;
  nelua_sequence_string__1 r2;
  int64_t r3;
} nlmulret_function_2KKnvHarpGFGqFSRr_nelua_sequence_string__1_nlint64;
static NELUA_INLINE nlmulret_function_2KKnvHarpGFGqFSRr_nelua_sequence_string__1_nlint64 nelua_ipairs_2(nelua_sequence_string__1 a);
static nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next_1(nelua_sequence_string__1 a_2, int64_t k);
...
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_5(nelua_stringbuilderT_ptr self, nlstring fmt, nlstring __arg1, nlstring __arg2);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_6(nelua_stringbuilderT_ptr self, nlstring fmt, int __arg1, nlstring __arg2, nlstring __arg3);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_7(nelua_stringbuilderT_ptr self, nlstring fmt);
...
static NELUA_NORETURN void nelua_error_string(nlstring msg);
...
typedef int (*function_4dsUyfFMrkwwsjMJQ)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_4dsUyfFMrkwwsjMJQ closef;
};
...
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_3(nelua_filestream_ptr self, nlstring fmt, int __arg1);
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_4(nelua_filestream_ptr self, nlstring fmt, nlstring __arg1, nlstring __arg2);
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_5(nelua_filestream_ptr self, nlstring fmt, int __arg1, nlstring __arg2, nlstring __arg3);
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_6(nelua_filestream_ptr self, nlstring fmt);
...
static void bwrapbox_fail_1(nlstring msg, int __arg1);
static void bwrapbox_fail_2(nlstring msg, nlstring __arg1, nlstring __arg2);
static void bwrapbox_fail_3(nlstring msg, int __arg1, nlstring __arg2, nlstring __arg3);
static void bwrapbox_fail_4(nlstring msg);
...
nlmulret_function_3gxPkn6wkRU9apZHZ_nelua_sequence_limit_pair__nlint64 nelua_ipairs_1(nelua_sequence_limit_pair_ a) {
  return (nlmulret_function_3gxPkn6wkRU9apZHZ_nelua_sequence_limit_pair__nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_2KKnvHarpGFGqFSRr_nelua_sequence_string__1_nlint64 nelua_ipairs_2(nelua_sequence_string__1 a) {
  return (nlmulret_function_2KKnvHarpGFGqFSRr_nelua_sequence_string__1_nlint64){nelua_ipairs_next_1, a, 0};
}
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_5(nelua_stringbuilderT_ptr self, nlstring fmt, nlstring __arg1, nlstring __arg2) {
  uintptr_t pos = 0U;
  uintptr_t written = 0U;
  int32_t argi = 0;
  while((pos < fmt.size)) {
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_6(nelua_stringbuilderT_ptr self, nlstring fmt, int __arg1, nlstring __arg2, nlstring __arg3) {
  uintptr_t pos = 0U;
  uintptr_t written = 0U;
  int32_t argi = 0;
  while((pos < fmt.size)) {
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_7(nelua_stringbuilderT_ptr self, nlstring fmt) {
  uintptr_t pos = 0U;
  uintptr_t written = 0U;
  int32_t argi = 0;
  while((pos < fmt.size)) {
...
void nelua_error_string(nlstring msg) {
  if(msg.size > 0) {
    nelua_write_stderr((const char*)msg.data, msg.size, true);
  }
  nelua_abort();
    ...
    if(((endpos != -1) && (endpos != lastmatch))) {
      ...
      while(true) {
        ...
        if((c == 37U)) {
          ...
          nelua_error_string(((nlstring){(uint8_t*)"invalid use of '%' in replacement string", 40}));
        }
        ri = ((ri + advance) + 2);
      }
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_3(nelua_filestream_ptr self, nlstring fmt, int __arg1) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_4(nelua_filestream_ptr self, nlstring fmt, nlstring __arg1, nlstring __arg2) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
  nelua_stringbuilderT sb = (nelua_stringbuilderT){0};
  if((!nelua_stringbuilderT_writef_5((&sb), fmt, __arg1, __arg2).r1)) {
    nlmulret_nlboolean_nlstring_nlint64 _mulret_1;
    _mulret_1.r1 = false;
    _mulret_1.r2 = ((nlstring){(uint8_t*)"not enough memory", 17});
    _mulret_1.r3 = 0;
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_5(nelua_filestream_ptr self, nlstring fmt, int __arg1, nlstring __arg2, nlstring __arg3) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
  nelua_stringbuilderT sb = (nelua_stringbuilderT){0};
  if((!nelua_stringbuilderT_writef_6((&sb), fmt, __arg1, __arg2, __arg3).r1)) {
    nlmulret_nlboolean_nlstring_nlint64 _mulret_1;
    _mulret_1.r1 = false;
    _mulret_1.r2 = ((nlstring){(uint8_t*)"not enough memory", 17});
    _mulret_1.r3 = 0;
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_6(nelua_filestream_ptr self, nlstring fmt) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
  nelua_stringbuilderT sb = (nelua_stringbuilderT){0};
  if((!nelua_stringbuilderT_writef_7((&sb), fmt).r1)) {
    nlmulret_nlboolean_nlstring_nlint64 _mulret_1;
    _mulret_1.r1 = false;
    _mulret_1.r2 = ((nlstring){(uint8_t*)"not enough memory", 17});
    _mulret_1.r3 = 0;
...
void bwrapbox_fail_1(nlstring msg, int __arg1) {
  nelua_filestream_writef_3((&nelua_io_stderr), msg, __arg1);
...
void bwrapbox_fail_2(nlstring msg, nlstring __arg1, nlstring __arg2) {
  nelua_filestream_writef_4((&nelua_io_stderr), msg, __arg1, __arg2);
  nelua_filestream_write_1((&nelua_io_stderr), ((nlstring){(uint8_t*)"\n", 1}));
  nelua_filestream_flush((&nelua_io_stderr));
  if(bwrapbox_is_child) {
    _exit(-1);
...
void bwrapbox_fail_3(nlstring msg, int __arg1, nlstring __arg2, nlstring __arg3) {
  nelua_filestream_writef_5((&nelua_io_stderr), msg, __arg1, __arg2, __arg3);
  nelua_filestream_write_1((&nelua_io_stderr), ((nlstring){(uint8_t*)"\n", 1}));
  nelua_filestream_flush((&nelua_io_stderr));
  if(bwrapbox_is_child) {
    _exit(-1);
...
void bwrapbox_fail_4(nlstring msg) {
  nelua_filestream_writef_6((&nelua_io_stderr), msg);
  nelua_filestream_write_1((&nelua_io_stderr), ((nlstring){(uint8_t*)"\n", 1}));
  nelua_filestream_flush((&nelua_io_stderr));
  if(bwrapbox_is_child) {
    _exit(-1);
...
nlmulret_nlcint_nlstring bwrapbox_wait_child_pid(int pid) {
  ...
  if((waitpid(pid, (&status), 0) != pid)) {
    return (nlmulret_nlcint_nlstring){130, ((nlstring){(uint8_t*)"interrupted", 11})};
  }
  if(WIFEXITED(status)) {
    ...
    bwrapbox_fail_1(((nlstring){(uint8_t*)"unhandled wait status %d", 24}), status);
...
void bwrapbox_cgroup_create(nlstring cgroup_path) {
  ...
  if((!ok)) {
    bwrapbox_fail_2(((nlstring){(uint8_t*)"failed to create cgroup '%s': %s", 32}), cgroup_path, err);
  }
}
void bwrapbox_cgroup_kill_and_destroy(nlstring cgroup_path) {
  if(bwrapbox_isdir(cgroup_path)) {
    ...
    nlstring err = _asgnret_1.r2;
    if((!ok)) {
      bwrapbox_fail_2(((nlstring){(uint8_t*)"failed to destroy cgroup '%s': %s", 33}), cgroup_path, err);
    }
    { /* defer */
...
void bwrapbox_cgroup_set_limits(nlstring cgroup_path, nelua_sequence_limit_pair_ limits) {
  {
    nlmulret_function_3gxPkn6wkRU9apZHZ_nelua_sequence_limit_pair__nlint64 _asgnret_1 = nelua_ipairs_1(limits);
    function_3gxPkn6wkRU9apZHZ __fornext = _asgnret_1.r1;
...
void bwrapbox_cgroup_migrate_pid(nlstring cgroup_path, int pid) {
  ...
  nlstring err = _asgnret_1.r2;
  if((!ok)) {
    bwrapbox_fail_3(((nlstring){(uint8_t*)"failed to migrate pid %d to create cgroup '%s': %s", 50}), pid, cgroup_path, err);
  }
  { /* defer */
    nelua_nlstring___close((&content));
  }
...
nelua_sequence_cstring_ bwrapbox_parse_args(void) {
  ...
  if((!help)) {
    {
      nlmulret_function_2KKnvHarpGFGqFSRr_nelua_sequence_string__1_nlint64 _asgnret_1 = nelua_ipairs_2(nelua_arg);
      function_2KKnvHarpGFGqFSRr __fornext = _asgnret_1.r1;
  ...
  while((i <= nelua_sequence_string__1___len((&nelua_arg)))) {
    if(nelua_nlstring___eq((*nelua_sequence_string__1___atindex((&nelua_arg), (uintptr_t)i)), ((nlstring){(uint8_t*)"--", 2}))) {
      ...
      if((!bwrapbox_cgroup_enabled)) {
        bwrapbox_fail_4(((nlstring){(uint8_t*)"enable cgroup to limit time", 27}));
      }
...
void bwrapbox_bwrap_exec(nelua_sequence_cstring_ args, nelua_sequence_limit_pair_ rlimits, uint32_t uid, uint32_t gid) {
  ...
  if(((gid != 0xffffffffLL) && (getgid() != gid))) {
    if((setgid((unsigned int)gid) < 0)) {
      bwrapbox_fail_4(((nlstring){(uint8_t*)"setgid failed", 13}));
    }
  }
  if(((uid != 0xffffffffLL) && (getuid() != uid))) {
    if((setuid((unsigned int)uid) < 0)) {
      bwrapbox_fail_4(((nlstring){(uint8_t*)"setuid failed", 13}));
    }
  }
  if((({
    ...
    bwrapbox_fail_4(((nlstring){(uint8_t*)"failed to exec bwrap", 20}));
  }
...
void bwrapbox_after_fork(void) {
  if((prctl(PR_SET_PDEATHSIG, (unsigned long)SIGKILL, 0U, 0U, 0U) != 0)) {
    bwrapbox_fail_4(((nlstring){(uint8_t*)"prctl() with PR_SET_PDEATHSIG failed", 36}));
  }
}
int bwrapbox_fork_cgroup_time_limiter(nlstring cgroup_path_2, int64_t cpu_high_usecs, int64_t cpu_max_usecs, int64_t time_high_usecs, int64_t time_max_usecs, int kill_pid) {
  ...
  if((pid == 0)) {
    ...
    bwrapbox_fail_4(((nlstring){(uint8_t*)"limiter fork() failed", 21}));
  }
  return pid;
}
int bwrapbox_fork_cgroup_bwrap_exec(nlstring cgroup_path_3, nelua_sequence_cstring_ args, nelua_sequence_limit_pair_ rlimits, uint32_t uid, uint32_t gid) {
  ...
  if((pid == 0)) {
    ...
    bwrapbox_fail_4(((nlstring){(uint8_t*)"bwrap fork() failed", 19}));
  }
  return pid;
}
  ...
  if(bwrapbox_cgroup_enabled) {
    ...
    if((!bwrapbox_quiet)) {
      ...
      if((nelua_nlstring___eq(reason, ((nlstring){(uint8_t*)"killed", 6})) && (status == SIGXCPU))) {
        nelua_filestream_printf_1((&nelua_io_stderr), ((nlstring){(uint8_t*)"[bwrapbox] application time exceeded after %d real usecs and %d CPU usecs\n", 74}), elapsed_usecs, cputime_usec);
      } else {
        nelua_filestream_printf_2((&nelua_io_stderr), ((nlstring){(uint8_t*)"[bwrapbox] application %s with status %d after %d real usecs and %d CPU usecs\n", 78}), reason, status, elapsed_usecs, cputime_usec);
      }
    }
    exit(status);
  } else {
