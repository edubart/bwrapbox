...
/* Compile command: gcc -x c "bwrapbox.c" -x none -fwrapv -fno-strict-aliasing -g -o "bwrapbox" */
/* Compile hash: 3isjvxUmDW8QtJJ1pCuaw5TCFCYa */
/* ------------------------------ DIRECTIVES -------------------------------- */
#include <stdbool.h>
...
typedef nlmulret_nlboolean_nlint64_bwrapbox_limit_pair (*function_4Cd96sF4ctjJbG4xP)(nelua_sequence_limit_pair_, int64_t);
struct nelua_sequenceimpl_limit_pair_ {
  nelua_span_limit_pair_ data;
  uintptr_t size;
};
typedef struct nlmulret_function_4Cd96sF4ctjJbG4xP_nelua_sequence_limit_pair__nlint64 {
  function_4Cd96sF4ctjJbG4xP r1;
  nelua_sequence_limit_pair_ r2;
  int64_t r3;
} nlmulret_function_4Cd96sF4ctjJbG4xP_nelua_sequence_limit_pair__nlint64;
static NELUA_INLINE nlmulret_function_4Cd96sF4ctjJbG4xP_nelua_sequence_limit_pair__nlint64 nelua_ipairs_1(nelua_sequence_limit_pair_ a);
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_21U26xu8AVVa8Jx9P)(nelua_sequence_string__1, int64_t);
struct nelua_sequenceimpl_string__1 {
  nelua_span_string_ data;
  uintptr_t size;
};
typedef struct nlmulret_function_21U26xu8AVVa8Jx9P_nelua_sequence_string__1_nlint64 {
  function_21U26xu8AVVa8Jx9P r1;
  nelua_sequence_string__1 r2;
  int64_t r3;
} nlmulret_function_21U26xu8AVVa8Jx9P_nelua_sequence_string__1_nlint64;
static NELUA_INLINE nlmulret_function_21U26xu8AVVa8Jx9P_nelua_sequence_string__1_nlint64 nelua_ipairs_2(nelua_sequence_string__1 a);
...
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_3(nelua_stringbuilderT_ptr self, nlstring fmt, int64_t __arg1);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_4(nelua_stringbuilderT_ptr self, nlstring fmt, nlstring __arg1, int __arg2, int64_t __arg3);
...
static nlstring nelua_tostring_2(intptr_t x);
static nlstring nelua_tostring_3(int64_t x);
static nlstring nelua_tostring_4(int x);
...
typedef int (*function_3WrRDDa8iwVNzPEtM)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_3WrRDDa8iwVNzPEtM closef;
};
...
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_1(nelua_filestream_ptr self, nlstring fmt, int64_t __arg1);
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_2(nelua_filestream_ptr self, nlstring fmt, nlstring __arg1, int __arg2, int64_t __arg3);
...
static void nelua_filestream_printf_1(nelua_filestream_ptr self, nlstring __arg1, int64_t __arg2);
static void nelua_filestream_printf_2(nelua_filestream_ptr self, nlstring __arg1, nlstring __arg2, int __arg3, int64_t __arg4);
...
static void bwrapbox_cgroup_wait_cputime_and_kill(nlstring cgroup_path_1, int64_t max_usecs, int pid, int sig);
static void bwrapbox_after_fork(void);
static int bwrapbox_fork_cgroup_time_limiter(nlstring cgroup_path_2, int64_t high_usecs, int64_t max_usecs, int kill_pid);
...
nlmulret_function_4Cd96sF4ctjJbG4xP_nelua_sequence_limit_pair__nlint64 nelua_ipairs_1(nelua_sequence_limit_pair_ a) {
  return (nlmulret_function_4Cd96sF4ctjJbG4xP_nelua_sequence_limit_pair__nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_21U26xu8AVVa8Jx9P_nelua_sequence_string__1_nlint64 nelua_ipairs_2(nelua_sequence_string__1 a) {
  return (nlmulret_function_21U26xu8AVVa8Jx9P_nelua_sequence_string__1_nlint64){nelua_ipairs_next_1, a, 0};
}
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_3(nelua_stringbuilderT_ptr self, nlstring fmt, int64_t __arg1) {
  uintptr_t pos = 0U;
  uintptr_t written = 0U;
  int32_t argi = 0;
  while((pos < fmt.size)) {
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_4(nelua_stringbuilderT_ptr self, nlstring fmt, nlstring __arg1, int __arg2, int64_t __arg3) {
  uintptr_t pos = 0U;
  uintptr_t written = 0U;
  int32_t argi = 0;
  while((pos < fmt.size)) {
        ...
        if((c == 37U)) {
          ...
          if((((!ok) && (capindex == 0)) && (ms.numcaptures == 0))) {
            ...
            if(nelua_StrPattCapture_is_position((&capture))) {
              nlstring s_8 = nelua_tostring_2((capture.init + 1));
...
nlstring nelua_tostring_2(intptr_t x) {
  nluint8_arr48 buf;
...
nlstring nelua_tostring_4(int x) {
  nluint8_arr48 buf;
  nlstring s = nelua_strconv_1_int2str_2((&buf), (intptr_t)x, NELUA_NIL);
  return nelua_nlstring_copy(s);
}
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_1(nelua_filestream_ptr self, nlstring fmt, int64_t __arg1) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
  nelua_stringbuilderT sb = (nelua_stringbuilderT){0};
  if((!nelua_stringbuilderT_writef_3((&sb), fmt, __arg1).r1)) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_2(nelua_filestream_ptr self, nlstring fmt, nlstring __arg1, int __arg2, int64_t __arg3) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
  nelua_stringbuilderT sb = (nelua_stringbuilderT){0};
  if((!nelua_stringbuilderT_writef_4((&sb), fmt, __arg1, __arg2, __arg3).r1)) {
    nlmulret_nlboolean_nlstring_nlint64 _mulret_1;
    _mulret_1.r1 = false;
    _mulret_1.r2 = ((nlstring){(uint8_t*)"not enough memory", 17});
    _mulret_1.r3 = 0;
...
void nelua_filestream_printf_1(nelua_filestream_ptr self, nlstring __arg1, int64_t __arg2) {
  nelua_filestream_writef_1(self, __arg1, __arg2);
  nelua_filestream_flush(self);
}
void nelua_filestream_printf_2(nelua_filestream_ptr self, nlstring __arg1, nlstring __arg2, int __arg3, int64_t __arg4) {
  nelua_filestream_writef_2(self, __arg1, __arg2, __arg3, __arg4);
  nelua_filestream_flush(self);
}
...
void bwrapbox_cgroup_kill_and_destroy(nlstring cgroup_path) {
  if(bwrapbox_isdir(cgroup_path)) {
    nlstring kill_path = nelua_nlstring___concat_1(cgroup_path, ((nlstring){(uint8_t*)"/cgroup.kill", 12}));
    bwrapbox_fs_mkfile(kill_path, ((nlstring){(uint8_t*)"1", 1}));
    nlstring procs_path = nelua_nlstring___concat_1(cgroup_path, ((nlstring){(uint8_t*)"/cgroup.procs", 13}));
    {
      bool _repeat_stop;
      do {
...
void bwrapbox_cgroup_set_limits(nlstring cgroup_path, nelua_sequence_limit_pair_ limits) {
  {
    nlmulret_function_4Cd96sF4ctjJbG4xP_nelua_sequence_limit_pair__nlint64 _asgnret_1 = nelua_ipairs_1(limits);
    function_4Cd96sF4ctjJbG4xP __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = i;
      {
        ...
        nlstring content = nelua_tostring_3(limit.value);
...
int64_t bwrapbox_cgroup_cputime_usecs(nlstring cgroup_path) {
  nlstring path = nelua_nlstring___concat_1(cgroup_path, ((nlstring){(uint8_t*)"/cpu.stat", 9}));
...
void bwrapbox_print_help(nlstring arg0) {
  nelua_print_1(nelua_nlstring___concat_1(((nlstring){(uint8_t*)"usage: ", 7}), nelua_nlstring___concat_1(arg0, ((nlstring){(uint8_t*)nelua_strlit_1, 554}))));
}
nelua_sequence_cstring_ bwrapbox_parse_args(void) {
  ...
  if((!help)) {
    {
      nlmulret_function_21U26xu8AVVa8Jx9P_nelua_sequence_string__1_nlint64 _asgnret_1 = nelua_ipairs_2(nelua_arg);
      function_21U26xu8AVVa8Jx9P __fornext = _asgnret_1.r1;
  ...
  while((i <= nelua_sequence_string__1___len((&nelua_arg)))) {
    if(nelua_nlstring___eq((*nelua_sequence_string__1___atindex((&nelua_arg), (uintptr_t)i)), ((nlstring){(uint8_t*)"--", 2}))) {
      ...
      if(((nelua_nlstring___len(bwrapbox_cgroup_path) > 0) && ((*nelua_nlstring___atindex(bwrapbox_cgroup_path, 1U)) != 47U))) {
        bwrapbox_cgroup_path = nelua_nlstring___concat_1(((nlstring){(uint8_t*)"/sys/fs/cgroup/", 15}), bwrapbox_cgroup_path);
      }
      i = (i + 1);
...
void bwrapbox_cgroup_wait_cputime_and_kill(nlstring cgroup_path_1, int64_t max_usecs, int pid, int sig) {
  while(true) {
    int64_t usage_usec = bwrapbox_cgroup_cputime_usecs(cgroup_path_1);
    if((usage_usec < 0)) {
      return;
    } else if((usage_usec >= max_usecs)) {
      kill(pid, sig);
      return;
    } else {
      bwrapbox_usleep((max_usecs - usage_usec));
    }
  }
}
...
int bwrapbox_fork_cgroup_time_limiter(nlstring cgroup_path_2, int64_t high_usecs, int64_t max_usecs, int kill_pid) {
  if(((high_usecs < 0) && (max_usecs < 0))) {
    return -1;
  }
  int pid = fork();
  if((pid == 0)) {
    ...
    bwrapbox_after_fork();
    if((high_usecs >= 0)) {
      bwrapbox_cgroup_wait_cputime_and_kill(cgroup_path_2, high_usecs, kill_pid, SIGXCPU);
    }
    if((max_usecs >= 0)) {
      bwrapbox_cgroup_wait_cputime_and_kill(cgroup_path_2, max_usecs, kill_pid, SIGKILL);
    }
    _exit(0);
  } else if((pid < 0)) {
...
int nelua_main(int argc, char** argv) {
  ...
  if(bwrapbox_cgroup_enabled) {
    ...
    bwrapbox_fork_cgroup_time_limiter(bwrapbox_cgroup_path, bwrapbox_cgroup_high_usecs, bwrapbox_cgroup_max_usecs, bwrap_pid);
    ...
    if((!bwrapbox_quiet)) {
      if((nelua_nlstring___eq(reason, ((nlstring){(uint8_t*)"killed", 6})) && (status == SIGXCPU))) {
        nelua_filestream_printf_1((&nelua_io_stderr), ((nlstring){(uint8_t*)"[bwrapbox] application CPU time exceeded after %d usecs\n", 56}), cputime_usec);
      } else {
        nelua_filestream_printf_2((&nelua_io_stderr), ((nlstring){(uint8_t*)"[bwrapbox] application %s with status %d after %d usecs\n", 56}), reason, status, cputime_usec);
      }
    }
    exit(status);
  } else {
